...
public class GiveArmor : SpellAlteration
{
    [SerializeField] int ratioSpellDamageToArmorPoints;
    public override void OnFireProjectile(Projectile _projectile)
    {
        DamageStruct dmg = _projectile.DamageDescriptor;
        dmg.amountArmor += (int)(dmg.amountDamag * (ratioSpellDamageToArmorPoints / 100.0f));
