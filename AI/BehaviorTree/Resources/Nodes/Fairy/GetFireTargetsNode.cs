...
public class GetFireTargetsNode : Node
{
    ...
    public override NodeState Evaluate(BlackBoard _bb)
    {
        ...
        Collider[] collidersAround = Physics.OverlapSphere(_bb.transform.position, (_bb as BlackBoardFairy).FireSH.Spell.Range + (_bb.Character.CurrentPa - (_bb as BlackBoardFairy).FireSH.Spell.Cost));
